# Copilot Instructions for SeedanceCli
...
2. **Compare parameters** — CLI command parameters in `seedance_cli/commands/` should match the corresponding OpenAPI endpoint's request body schema.
...
4. **Update client** — If API endpoints change, update `seedance_cli/core/client.py` accordingly.
