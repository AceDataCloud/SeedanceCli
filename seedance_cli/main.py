...
A command-line tool for generating AI videos using Seedance
...
def get_version() -> str:
    ...
    try:
        return metadata.version("seedance-cli")
    except metadata.PackageNotFoundError:
        return "dev"


@click.group()
@click.version_option(version=get_version(), prog_name="seedance-cli")
@click.option(
    "--token",
...
def cli(ctx: click.Context, token: str | None) -> None:
    """Seedance CLI - AI Video Generation powered by AceDataCloud.
    ...
    Examples:
      ...
      seedance task abc123-def456
      seedance wait abc123 --interval 5
