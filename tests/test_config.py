...
def test_settings_from_environment():
    ...
    os.environ["SEEDANCE_REQUEST_TIMEOUT"] = "300"
    os.environ["SEEDANCE_DEFAULT_MODEL"] = "doubao-seedance-1-5-pro-251215"
    ...
    try:
        ...
        del os.environ["SEEDANCE_REQUEST_TIMEOUT"]
        del os.environ["SEEDANCE_DEFAULT_MODEL"]
